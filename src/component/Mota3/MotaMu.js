...
import { Garys } from "./../Mũ/data";
import { useState } from "react";
import DetaMu from "./detaMu";
import DetaThum from "./detaSon";
import TabMota from "./formMu/tabMota";
import SiceXet from "./formMu/siceXet";
              ...
              <div className="container__Mota">
                    ...
                    <div className="descriptions">
                      <div className="description1">
                        ...
                        <div className="information-des">
                          <div>
                            <span>
                              <span className="informas">Giới tính :</span>
                              {product.machie}
                            </span>
                          </div>
                          <br></br>
                          <div className="informa">
                            <span>
                              <span className="informas">chất liệu :</span>
                              {product.Facecolor}
                            </span>
                          </div>
                          <br />
                ...
                <div className="foucus-content">
                  ...
                  <div className="foucus-content3">
                    <DetaMu image={product.image} setindexs={setIndexs} />
                  </div>
                </div>

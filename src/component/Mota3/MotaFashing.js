...
import {Garys} from "./../Thoitrang/data"
import{useState} from "react"
import DetaFashing  from "./detaThum";

import TabMota from "./formFashing/tabMota"
import SiceXet from "./formFashing/siceXet"
const ProductDetails = (props) => {
  ...
  const imgDiv = useRef()
    const{fashingId}=useParams();
    const dispatch = useDispatch()
console.log(product)
    let detas = product.filter((item,index)=>{
      return item.id===fashingId
    })
   ...
   <div>
      ...
      <div className="container__Mota">
              ...
              <div className="containet_fulter">
                    ...
                    <span ><span className="informas">Xuất xứ :</span>{product.machie}</span>
                     ...
                     <div>
                        ...
                        <div className="information-des">
                          <div >
                          <span ><span className="informas">Thương hiệu  :</span>{product.trademark}</span>
                            </div><br></br>
                         <div className="informa">
                         <span ><span className="informas">Kiểu dáng  :</span>{product.cord}</span>
                           </div><br/>
                         <div className="informa">
                         <span ><span className="informas">Size :</span> {product.machie}</span>
                           </div><br/>
                         <div className="informa">
                         <span><span className="informas">Gọi đặt mua :</span> <strong style={{color:"crimson"}}>093.934.8888</strong> (7:30 - 22:00)</span>
                          ...
                          <div className="add">
                            <button className="edit"  onClick={productssss(product)}>THÊM VÀO GIỎ HÀNG</button>
                            ...
                            <div className="foucus-content1">
                             ...
                             <span> <BiCheckSquare /> {product.name} <strong className="price-foucus">{product.price}</strong></span><br/>
                              ...
                              <div className="foucus-content3">
                                   <DetaFashing image={product.image} setindexs={setIndexs} />
                                </div>
                     </div>
                  ...
                  <div className="foucus_end2-fashing">

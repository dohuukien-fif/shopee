...
import {Garys} from "./../son/data"
import{useState} from "react"
import DetaTui  from "./detaSon";
import DetaThum from "./detaSon";
import TabMota from "./formson/tabMota"
import SiceXet from "./formson/siceXet"
const ProductDetails = (props) => {
  ...
  const imgDiv = useRef()
    const{sonId}=useParams();
    const dispatch = useDispatch()
    const productsssss = (productsss)=>{
      ...
      <div className="container__Mota">
              ...
              <div className="containet_fulter">
                  ...
                  <div className="container_fulter1">
                    ...
                    < img className="image-Mota" onMouseMove={handleMouseMove} src={`${product.image[Indexs]}`} ref={imgDiv}
                     ...
                     <div>
                        ...
                        <div className="information-des">
                         ...
                         <span><span className="informas">Gọi đặt mua :</span> <strong style={{color:"crimson"}}>093.934.8888</strong> (7:30 - 22:00)</span>
                          ...
                          <div className="add">
                            <button className="edit"  onClick={productsssss(product)}>THÊM VÀO GIỎ HÀNG</button>
                    ...
                    <div className="foucus_des" >
                          <span><strong>Sản phẩm thường mua cùng</strong><span className="foucus-fulter">(Giảm 20.000 ₫ với mỗi sản phẩm mua kèm)</span></span>
                    <span><strong><i>Lựa chon khác</i></strong></span>
                   </div>
                   <div className="foucus-content">
                            <div className="foucus-content1">
                              <img src={`${product.image[0]}`}/> <FaPlus className="icon1"  />  <img src={`${product.image[1]}`}/> <FaPlus className="icon1" />  <img src={`${product.image[2]}`}/>
                              </div>
                             <div className="foucus-content2">
                             <span> <BiCheckSquare /> {product.name} <strong className="price-foucus">{product.price}</strong></span><br/>
                              <span> <BiCheckSquare /> <Link>{product.name}</Link> <strong className="price-foucus">{product.price}</strong></span><br/>
                              <span> <BiCheckSquare /><Link> {product.name} </Link><strong className="price-foucus">{product.price}</strong></span>
                                    <div className="foucus-content2-2">
                                        <span >Tổng tiền <span className="price-foucuss">{product.price}</span></span>
                                        <button className="edits"> + THÊM VÀO GIỎ HÀNG</button>
                                      </div>
                               </div>

                              <div className="foucus-content3">
                                   <DetaTui image={product.image} setindexs={setIndexs} />
                                </div>
                     </div>
                     <div className="foucus_end">
                  <div className="foucus_end1">
                  <TabMota name={product.name} 
                       price={product.price} 
                       image={product.image}
                  ...
                  <div className="foucus_end2">
                  <h4 className="title_foucus_end2">Có thể bạn quan tâm</h4>
                  <div className="foucus_end2-2">
                    <span><Link>Đồng hồ</Link></span>
                    <span><Link>Mũ Lacoste</Link></span>
                    <span><Link>Túi sách hiệu</Link></span>
                    <span><Link>Mũ Gucci</Link></span>
                    <span><Link>Son Mac</Link></span>
                    <span><Link>Nước hoa</Link></span>
                    <span><Link>Máy rửa mặt </Link></span>
                    <span><Link>Lăn Khử mùi</Link></span>
                    <span><Link>Giày</Link></span>
                    <span><Link>Kem </Link></span>
                    <span><Link>Son môi</Link></span>
                    <span><Link>Áo phông</Link></span>
                    <span><Link>MLB</Link></span>
                  ...
                  <div className="foucus_end2-3">
                     ...
                     <div className="title_foucus_end2-3-3">
                          <div>
                         <img className="image_fouter2" src={product.image[0]}/>
                          </div>
                          <div>
                            <span className='name_foucus2'>{product.name}</span><br/>
                           <div className="custom-price">
                           <span className="price_foucus2">{product.price}</span><br/>
                            <span className="price1-foucus2">{product.price1}</span>
                           </div>
                     ...
                     <div className="title_foucus_end2-3-3">
                          <div>
                                 <img  className="image_fouter2" src={product.image[1]}/>
                          </div>
                          <div>
                            <span className='name_foucus2'>{product.name}</span><br/>
                            <div className="custom-price">
                       ...
                       <div className="title_foucus_end2-3-3">
                          <div>
                                 <img className="image_fouter2" src={product.image[2]}/>
                          </div>
                       ...
                       <div className="title_foucus_end2-3-3">
                          <div>
                                 <img className="image_fouter2" src={product.image[3]}/>
                          </div>
                          <div>
                            <span className='name_foucus2'>{product.name}</span><br/>
                            <div className="custom-price">
                      ...
                      <div className="information_foucus2">
                         <div className="information_foucus2-1">
                        <div className="title-information-foucus2">
                        <span ><strong className="name-foucus2-1">{product.name}</strong></span><br/>

                        </div>
           <div className="information-information_foucus2">

           <span><span className="information_foucus2-2">Giới tính :</span> {product.Facecolor}</span><br/>
                             <span><span className="information_foucus2-2">Xuất xứ : </span>{product.cord}</span><br/>
                             <span><span className="information_foucus2-2">Màu :</span> {product.machie}</span><br/> 
           </div>
                             <span className="price_information-foucus2"><span className="information_foucus2-2">Giá bán :</span> {product.price}</span><br/>
                            <div className="btn-information-foucus2">
                            <button className="information_foucus2-btn">MUA NGAY</button><br/>
                             <button className="information_foucus2-btn">HOTLINE : 093.934.8888</button>
...
<h4 className="title-Motas">Sản phẩm khác của gian hàng Mỹ phẩm Sino</h4>

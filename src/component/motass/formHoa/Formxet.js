  ...
  return (
    ...
    <div className="container">
        ...
        <Input type="textarea" name="text" id="exampleText"     onChange={handleChange}
          value={todo} placeholder="Nhận xét về sản phẩm của bạn" />
      </FormGroup>
      <FormGroup>
        <Label for="examplename" className="laber-form">Thông tin cá nhân của bạn (<i>Thông tin của bạn được bảo mật</i>)</Label>

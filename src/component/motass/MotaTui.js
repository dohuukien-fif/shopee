...
import {Datas} from "./../túi/data"
import{useState} from "react"
import DetaTui  from "./detaTui";

import TabMota from "./formTui/tabMota"
import SiceXet from "./formTui/siceXet"
                    ...
                    <span ><span className="informas">Xuất xứ :</span>{product.machie}</span>
                     ...
                     <div>
                        ...
                        <div className="information-des">
                         ...
                         <span ><span className="informas">Chất liệu :</span>{product.cord}</span>
                           </div><br/>
                         <div className="informa">
                         <span ><span className="informas">Xuất xứ  :</span> {product.machie}</span>
                           </div><br/>

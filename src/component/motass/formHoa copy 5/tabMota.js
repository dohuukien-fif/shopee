    ...
    return (
      ...
      <div className="foucus_end1">
                 ...
                 <div className={toager === 1 ? "content active-content" : "content"}>
                     <p>
                   <strong>  {name}</strong> là dòng son dưỡng cao cấp và đắt đỏ trên thị trường son hiện nay. <strong>Son Dior 001 Pink </strong>sở hữu thiết kế thanh lịch, ngọt ngào hoàn hảo kết hợp với chất son sáp mềm mượt, trong trẻo cùng với màu son hồng nhẹ khiến bất cứ cô nàng nào cũng khao khát có được.
                     </p>
                     <p>
                     Dior 001 Pink Addict Lip Glow là một trong những thởi son best-seller của hãng Dior và được giới mộ điệu coi như nàng “công chúa” trong thế giới son chăm sóc môi đa sắc màu, được mệnh danh là "người tình trong mộng" của mọi cô nàng.
                     </p>
                      <img className="image_tab" src={image[0]}/>
                      <h3><sttrong>{name}</sttrong></h3>
                        <p>
                        Kế thừa phong cách thanh lịch và sang trọng vốn có của Dior,<trong>{name}</trong> sở hữu vè ngoài đầy sức hút đẳng cấp với thân nhựa cao cấp phủ ánh kim bóng loáng, vỏ son có màu hồng nhạt trong trẻo.
                        </p>
                      <p>
                    <strong>{name}</strong> sáng bóng được bao bọc bởi nắp nhựa hồng trong trẻo. Son nhỏ gọn mà chắc chắn. Dấu ấn thương hiệu son Dior được lồng ghép hài hoà khi có biểu tượng CD dập chìm trên thân. Ở đuôi còn có núm tròm khác biệt và tinh tế tạo cho người dùng cảm giác tiểu thư quyền quý.
                      </p>
                        ...
                        <p>
                        Cảm giác son lên màu thuần khiết, trong trẻo chứa đựng bao sự ngọt ngào. Dù môi thâm và bong tróc đều được “cứu cảnh cả”.
                        </p>
                        <h3><strong>Mùi hương {name}</strong></h3>
                         <p>Son sở hữu mùi hương ngọt ngào của kẹo đầy thu hút.</p>
                         <h3><strong>Độ bám màu Dior 001 Pink</strong></h3>
                         <img className="image_tab" src={image[1]}/><br/>

                       
                         <p>
                        <Link> Cây son</Link> có các thành phần chính là Wild Mango và Luffa Cylindrica, chứa thành phần chống nắng SPF 10 chống môi thâm và lão hóa. Cộng thêm chất son vừa phải, không dính môi, son lướt trên môi như một thỏi thạnh mềm mượt, che phủ đi các rãnh môi xấu xí, để lại đôi môi căng mọng với lớp màu trong trẻo.
                         </p>
                         <p>
                         Độ bóng trên môi sẽ mất dần đi sau khoảng 15 phút, lớp màu hồng hào tự nhiên được lưu lại lên tới vài giờ đồng hồ.
                         </p>
                         <p><strong>Son dưỡng Dior 001 Pink</strong>còn bền màu đến 3-4h liền.</p>

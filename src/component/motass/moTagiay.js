...
import {Datas} from "./../Giay/data"
import{useState} from "react"
import DetaGiay  from "./degiay";

import TabMota from "./formgiay/tabMota"
import SiceXet from "./formgiay/siceXet"
const ProductDetails = (props) => {
  ...
  const imgDiv = useRef()
    const{idsss}=useParams();
    const dispatch = useDispatch()
console.log(product)
    let detas = product.filter((item,index)=>{
      return item.id===idsss
    })
   ...
   <div>
      ...
      <div className="container__Mota">
              ...
              <div className="containet_fulter">
                    ...
                    <span ><span className="informas">Xuất xứ :</span>{product.machie}</span>
                     ...
                     <div>
                        ...
                        <div className="information-des">
                         ...
                         <span ><span className="informas">Size :</span>{product.cord}</span>
                           </div><br/>
                         <div className="informa">
                         <span ><span className="informas">Xuất xứ  :</span> {product.machie}</span>
                           </div><br/>
                            ...
                            <div className="foucus-content1">
                             ...
                             <span> <BiCheckSquare /> {product.name} <strong className="price-foucus">{product.price}</strong></span><br/>
                              ...
                              <div className="foucus-content3">
                                   <DetaGiay image={product.image} setindexs={setIndexs} />
                                </div>
                     </div>
                  ...
                  <div className="foucus_end2-giay">

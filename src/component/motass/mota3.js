...
import DetaWatch  from "./detaThum";

import TabMota from "./formWatch/tabMota"
import SiceXet from "./formWatch/siceXet"
   ...
   <div>
      ...
      <div className="container__Mota">
              ...
              <div className="containet_fulter">
                    ...
                    <span ><span className="informas">Xuất xứ :</span>{product.machie}</span>
                     ...
                     <div>
                        ...
                        <div className="information-des">
                         ...
                         <span ><span className="informas">Dây  :</span>{product.cord}</span>
                           </div><br/>
                         <div className="informa">
                         <span ><span className="informas">Đường kính :</span> {product.machie}</span>
                           </div><br/>
                         <div className="informa">
                            ...
                            <div className="foucus-content1">
                             ...
                             <span> <BiCheckSquare /> {product.name} <strong className="price-foucus">{product.price}</strong></span><br/>
                              ...
                              <div className="foucus-content3">
                                   <DetaWatch image={product.image} setindexs={setIndexs} />
                                </div>
                     </div>
                  ...
                  <div className="foucus_end2-watch">

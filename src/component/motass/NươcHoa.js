...
import {Datas} from "./../nươc hoa/data"
import{useState} from "react"
import DetaHoa  from "./deHoa";

import TabMota from "./formHoa/tabMota"
import SiceXet from "./formHoa/siceXet"
                    ...
                    <span ><span className="informas">Xuất xứ :</span>{product.machie}</span>
                     ...
                     <div>
                        ...
                        <div className="information-des">
                         ...
                         <span ><span className="informas">Nồng độ :</span>{product.cord}</span>
                           </div><br/>
                         <div className="informa">
                         <span ><span className="informas">Nhóm hương :</span> {product.Facecolor}</span>
                           </div><br/>
                         <div className="informa">
                            ...
                            <div className="foucus-content1">
                             ...
                             <span> <BiCheckSquare /> {product.name} <strong className="price-foucus">{product.price}</strong></span><br/>
                              ...
                              <div className="foucus-content3">
                                   <DetaHoa image={product.image} setindexs={setIndexs} />
                                </div>
                     </div>
